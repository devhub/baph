...
def setup(app):
    ...
    idx_template = "pair: %s; django-admin command-line option"
    app.add_description_unit(directivename="django-admin-option",
                             rolename="djadminopt",
                             indextemplate=idx_template,
...
class DjangoHTMLTranslator(SmartyPantsHTMLTranslator):
    ...
    def visit_versionmodified(self, node):
        ...
        title = "%s%s" % (self.version_text[node['type']] % node['version'],
                          len(node) and ":" or ".")
